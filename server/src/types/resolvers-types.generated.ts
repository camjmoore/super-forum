...
import { ApolloContext } from './IApolloContext';
...
export type ResolversTypes = ResolversObject<{
  ...
  ThreadArrayResult: ResolverTypeWrapper<
    ResolversUnionTypes<ResolversTypes>['ThreadArrayResult']
  >;
  ...
  ThreadItemArrayResult: ResolverTypeWrapper<
    ResolversUnionTypes<ResolversTypes>['ThreadItemArrayResult']
  >;
  ThreadItemPoint: ResolverTypeWrapper<ThreadItemPoint>;
  ThreadItemResult: ResolverTypeWrapper<
    ResolversUnionTypes<ResolversTypes>['ThreadItemResult']
  >;
  ThreadPoint: ResolverTypeWrapper<ThreadPoint>;
  ThreadResult: ResolverTypeWrapper<
    ResolversUnionTypes<ResolversTypes>['ThreadResult']
  >;
...
export type CategoryThreadResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['CategoryThread'] = ResolversParentTypes['CategoryThread'],
> = ResolversObject<{
...
export type EntityResultResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['EntityResult'] = ResolversParentTypes['EntityResult'],
> = ResolversObject<{
  messages?: Resolver<
...
> = ResolversObject<{
  ...
  createThread?: Resolver<
    Maybe<ResolversTypes['EntityResult']>,
    ParentType,
    ContextType,
    RequireFields<
      MutationCreateThreadArgs,
      'body' | 'categoryId' | 'title' | 'userId'
    >
  >;
  createThreadItem?: Resolver<
    Maybe<ResolversTypes['EntityResult']>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateThreadItemArgs, 'threadId' | 'userId'>
  >;
  login?: Resolver<
    ResolversTypes['String'],
    ParentType,
  ...
  logout?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationLogoutArgs, 'userName'>
  >;
  register?: Resolver<
  ...
  >;
  updateThreadItemPoint?: Resolver<
    ResolversTypes['String'],
    ParentType,
    ContextType,
    RequireFields<
      MutationUpdateThreadItemPointArgs,
      'increment' | 'threadItemId'
    >
  >;
  updateThreadPoint?: Resolver<
    ResolversTypes['String'],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateThreadPointArgs, 'increment' | 'threadId'>
  >;
}>;
...
> = ResolversObject<{
  getAllCategories?: Resolver<
    ResolversTypes['ThreadCategoryArray'],
    ParentType,
    ContextType
  >;
  getThreadById?: Resolver<
    Maybe<ResolversTypes['ThreadResult']>,
    ParentType,
    ContextType,
    RequireFields<QueryGetThreadByIdArgs, 'threadId'>
  >;
  getThreadItemByThreadId?: Resolver<
    ResolversTypes['ThreadItemArrayResult'],
    ParentType,
    ContextType,
    RequireFields<QueryGetThreadItemByThreadIdArgs, 'threadId'>
  >;
  getThreadsByCategoryId?: Resolver<
    ResolversTypes['ThreadArrayResult'],
    ParentType,
    ContextType,
    RequireFields<QueryGetThreadsByCategoryIdArgs, 'categoryId'>
  >;
  getThreadsLatest?: Resolver<
    ResolversTypes['ThreadArrayResult'],
    ParentType,
    ContextType
  >;
  getTopCategoryThread?: Resolver<
    Maybe<Array<ResolversTypes['CategoryThread']>>,
    ParentType,
    ContextType
  >;
...
> = ResolversObject<{
  ...
  threadCategory?: Resolver<
    ResolversTypes['ThreadCategory'],
    ParentType,
    ContextType
  >;
  threadItems?: Resolver<
    Maybe<Array<ResolversTypes['ThreadItem']>>,
    ParentType,
    ContextType
  >;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type ThreadArrayResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['ThreadArray'] = ResolversParentTypes['ThreadArray'],
> = ResolversObject<{
  threads?: Resolver<
...
export type ThreadArrayResultResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['ThreadArrayResult'] = ResolversParentTypes['ThreadArrayResult'],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'EntityResult' | 'ThreadArray',
    ParentType,
    ContextType
  >;
}>;
...
export type ThreadCategoryResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['ThreadCategory'] = ResolversParentTypes['ThreadCategory'],
> = ResolversObject<{
  createdBy?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdOn?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
...
export type ThreadCategoryArrayResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['ThreadCategoryArray'] = ResolversParentTypes['ThreadCategoryArray'],
> = ResolversObject<{
  threadCategories?: Resolver<
    Maybe<Array<ResolversTypes['ThreadCategory']>>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type ThreadItemResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['ThreadItem'] = ResolversParentTypes['ThreadItem'],
> = ResolversObject<{
  body?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdBy?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdOn?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
...
export type ThreadItemArrayResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['ThreadItemArray'] = ResolversParentTypes['ThreadItemArray'],
> = ResolversObject<{
  threadItems?: Resolver<
    Maybe<Array<ResolversTypes['ThreadItem']>>,
    ParentType,
...
export type ThreadItemArrayResultResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['ThreadItemArrayResult'] = ResolversParentTypes['ThreadItemArrayResult'],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'EntityResult' | 'ThreadItemArray',
    ParentType,
    ContextType
  >;
}>;

export type ThreadItemPointResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['ThreadItemPoint'] = ResolversParentTypes['ThreadItemPoint'],
> = ResolversObject<{
  createdBy?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdOn?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type ThreadItemResultResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['ThreadItemResult'] = ResolversParentTypes['ThreadItemResult'],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'EntityResult' | 'ThreadItem',
    ParentType,
    ContextType
  >;
}>;

export type ThreadPointResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['ThreadPoint'] = ResolversParentTypes['ThreadPoint'],
> = ResolversObject<{
  createdBy?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdOn?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type ThreadResultResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes['ThreadResult'] = ResolversParentTypes['ThreadResult'],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'EntityResult' | 'Thread',
    ParentType,
